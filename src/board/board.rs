use std::fmt;
use super::{Move, Piece, DIAGONALS, ANTI_DIAGONALS, RANKS, FILES, FILE_A, NOT_RANK_1_8, FILE_H, NOT_RANK_1_2, RANK_2, RANK_8, KING_SPAN, FILE_G, FILE_B, NOT_RANK_7_8, RANK_7, RANK_1, KNIGHT_SPAN,};
